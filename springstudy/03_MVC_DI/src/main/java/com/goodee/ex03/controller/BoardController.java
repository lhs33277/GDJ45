...
public class BoardController {
	...
	*/
	...
	// @Qualifier 애너테이션으로 bean의 구분을 한다. 쿼리파이어 안중요함.
	
	@Autowired
	@Qualifier(value="board1")	// <qualifier value="board1" /> 인 bean을 주입해 주세요.
	private Board board1;
	
	@Autowired
	@Qualifier(value="board2")	// <qualifier value="board2" /> 인 bean을 주입해 주세요.
