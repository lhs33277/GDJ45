...
<body>
	...
	<!-- Controller1에 요청하기 -->
	<a href="${contextPath}/detail1?name=이형식&age=30">정보전달1</a><br>
	<a href="${contextPath}/detail2?name=이형식&age=30">정보전달2</a><br>
	<a href="${contextPath}/detail3?name=이형식&age=30">정보전달3</a><br>
	<a href="${contextPath}/detail4?name=이형식&age=30">정보전달4</a><br>
	<a href="${contextPath}/detail5?name=이형식&age=30">정보전달5</a><br>
	<a href="${contextPath}/detail6?name=이형식&age=30">정보전달6</a><br>
	...
	<script>
		function fn1(f) {	// onclick=fn1(this.form)을 통해서 전체 내용이 매개변수 f에 전달
			f.action = '${contextPath}/remove1';
			f.submit();
		}
		function fn2(f) {	// onclick=fn2(this.form)을 통해서 전체 내용이 매개변수 f에 전달
			f.action = '${contextPath}/remove2';
			f.submit();
		}
		function fn3(f) {	// onclick=fn3(this.form)을 통해서 전체 내용이 매개변수 f에 전달
