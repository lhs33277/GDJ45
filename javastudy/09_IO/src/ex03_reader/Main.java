...
public class Main {
	...
	public static void m1() {
		...
		try {
			...
			// 입력 스트림 생성
			FileReader fr = new FileReader("F:\\storage\\m2.txt");
	...
	public static void m2() {	// 중요
		try {
			...
			while(true) {
				...
				int readCount = fr.read(cbuf);		// readCount에는 글자수5가 들어감
	...
	public static void m3() {
		try {
			BufferedReader br = new BufferedReader(new FileReader("F:\\storage\\m2.txt"));
	...
	// ReadLine 메소드 : 텍스트 파일의 Line(한 줄) 단위로 읽어 들임
	public static void m4() {
		
		try {
			BufferedReader br = new BufferedReader(new FileReader("F:\\storage\\m3.txt"));
...
try {
			...
			BufferedWriter bw = new BufferedWriter(new FileWriter("F:\\storage\\m3_복사본.txt"));
