...
public class Main {
	...
	public static void quiz() {
		...
		try {
			...
			// 복사본 생성하기 스트림
			BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream("F:\\storage\\eclipse.zip"));
	...
	public static void m3() {
		...
		try {
			...
			DataInputStream dis = new DataInputStream(new FileInputStream("F:\\storage\\b4.dat"));
	...
	public static void m4() {
		...
		try {
			...
			ObjectInputStream ois = new ObjectInputStream(new FileInputStream("F:\\storage\\b5.dat"));
