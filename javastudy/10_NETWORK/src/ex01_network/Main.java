...
public class Main {
	...
	// 3. 구성
	//    프로토콜://     호스트     /  서버경로  ?파라미터 <- 사용자들이 서버쪽으로 보내는 정보
	...
	public static void m2() {
		...
		try {
			...
			if(con.getResponseCode() == 200)	// 200번대가 정상요청, 완성된 api는 요청을 잘못한 400번대 오류가 많음. 500번대는 서버의 프로그램을 잘못 짠거임
	...
	public static void m3() {
		...
		try {
			...
			// 입력 스트림 생성(바이트 기반)
			InputStream in = con.getInputStream();	// 사용자가 읽어볼 때 쓰는거
