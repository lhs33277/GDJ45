...
ALTER TABLE BOARDS ADD CONSTRAINT BOARDS_MEMBERS_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBERS(MEMBER_ID);
...
-- 데이터 추가
INSERT INTO MEMBERS(MEMBER_NO, MEMBER_ID, NAME, REGISTE_DATE)
VALUES (MEMBERS_SEQ.NEXTVAL, 'admin', '관리자', SYSTIMESTAMP);

INSERT INTO MEMBERS(MEMBER_NO, MEMBER_ID, NAME, REGISTE_DATE)
VALUES (MEMBERS_SEQ.NEXTVAL, 'user', '사용자', SYSTIMESTAMP);
...
SELECT MEMBER_NO, MEMBER_ID
  FROM MEMBERS
 WHERE ROWID = 'AAAE+WAABAAALGRAAA';    -- 실제로 사용할 수 없는 방식(대신 INDEX를 사용함)
