...
-- 기본키는 별도로 지정
ALTER TABLE MEMBERS2 ADD CONSTRAINT MEMBERS2_PK PRIMARY KEY(MEMBER_NO);
...
-- 기본키는 별도로 지정
ALTER TABLE MEMBERS3 ADD CONSTRAINT MEMBERS3_PK PRIMARY KEY(MEMBER_NO);
...
-- 기본키는 별도로 지정
ALTER TABLE BOARDS2 ADD CONSTRAINT BOARDS2_PK PRIMARY KEY(BOARD_NO);
