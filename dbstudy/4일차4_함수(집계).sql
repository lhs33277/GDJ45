...
INSERT INTO STUDENT(NAME, KOR, ENG, MAT) VALUES('형식', 100, 100, 100);
...
SELECT
 ...
 -- , SUM(KOR + ENG + MAT)  : 어떤 레코드의 KOR + ENG + MAT의 합
    , SUM(KOR) + SUM(ENG) + SUM(MAT) -- 국어, 영어, 수학 전체의 합
    FROM STUDENT;
